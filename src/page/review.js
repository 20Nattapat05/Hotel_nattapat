            ...
            <div className="col-md-4 px-5">
                <div className="card bg-blue mb-5">
                    <div className="card-body">
                        ...
                        <img src="/images/pro-1.jpg" className="image-pro-review user" alt="Review by Username 111" />
                    </div>
                </div>
            </div>
            <div className="col-md-4 px-5">
                <div className="card bg-blue mb-5">
                    <div className="card-body">
                        ...
                        <h6 className="text-start ms-4 ps-3 text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Unde, at.</h6>
                        <img src="/images/pro-2.jpg" className="image-pro-review user" alt="Review by Username 222" />
                    </div>
                </div>
            </div>
            <div className="col-md-4 px-5">
                <div className="card bg-blue mb-5">
                    <div className="card-body">
                        ...
                        <h6 className="text-start ms-4 ps-3 text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Unde, at.</h6>
                        <img src="/images/pro-3.jpg" className="image-pro-review user" alt="Review by Username 333" />
                    </div>
                </div>
            </div>
        </div>
